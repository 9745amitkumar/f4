...
Question and Answer
Question(questionText: " Director of RRR is Rajamouli ", answer: true), Question(questionText: " Black box in plane is 
black ", answer: true), Question(questionText: " Mango is a fruit ", answer: true),
...
if (checkquestionNumber(questionNumber)) ElevatedButton(
onPressed: () {
setState(() {
...
Padding( padding: const EdgeInsets.all(30.0), child: Center( child: 
Text( "Current Score is:", style: TextStyle(fontSize: 30),
),
),
),
Padding( padding: const EdgeInsets.all(30.0), child: Center( 
child: Text( '${currentScore}', style: TextStyle(fontSize: 
30),
),
),
),
